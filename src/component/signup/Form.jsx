...
const Form = () => {
  ...
  const handleSubmit = async(event) => {
    ...
    if (data) {
      localStorage.setItem("photo", `https://travel-cg48.onrender.com/profile_images/${data.data.photo}`);
    ...
    console.log(data.data.photo)
      ...
      const { data}= await axios.post(`https://travel-cg48.onrender.com/user/create`,{first_name:name,last_name:last_name,mobile:8512929143,photo:photo,email,password})
